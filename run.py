...
def process(in_path, annot_beats=False, feature="pcp", framesync=False,
            ...
            config=None, out_bounds="out_bounds.wav", out_sr=22050, output_file=None):
    ...
    if os.path.isfile(in_path):
        ...
        if plot:
            custom_plotting.plot_one_track(file_struct, est_times, est_labels,
                                    boundaries_id, labels_id, output_file=output_file)
